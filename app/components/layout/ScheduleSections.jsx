...
const EventCard = ({ event, handleDelete }) => (
  <div className="card w-full shadow-lg border border-gray-100 hover:shadow-xl transition">
...
const CalendarComponent = ({ events, selectedDate, onDateSelect }) => {
  ...
  return (
    <div className="card shadow-xl p-5 w-full">
...
const App = () => {
  ...
  return (
    <div className="min-h-screen p-6">
      ...
      {/* Header */}
      <header className="mb-8 p-6 rounded-xl shadow-xl border-t-4 border-primary">
          ...
          <div className="flex justify-between items-center mb-6">
            <div>
              <h2 className="text-2xl font-semibold flex items-center space-x-3">
                <span>
                  {viewMode === "day" &&
                    `Task for ${selectedDate.toDateString()}`}
                  {viewMode === "month" &&
                    `Tasks in ${selectedDate.toLocaleString("en-US", {
                      month: "long",
                      year: "numeric",
                    })}`}
                  {viewMode === "week" &&
            ...
            <div className="flex space-x-3">
              <select
                className="select select-bordered select-sm bg-[var(--foreground)] border-1 border-gray-500"
                value={viewMode}
      ...
      {showModal && (
        <dialog className="modal modal-open ">
          <div className="modal-box bg-[var(--foreground)]">
            <button
            ...
            <div className="space-y-4">
              <input
                type="text"
                placeholder="Title"
                className="input input-bordered w-full bg-[var(--foreground)] border-2 border-gray-500"
              ...
              <select
                className="select select-bordered w-full bg-[var(--foreground)] border-2 border-gray-500"
